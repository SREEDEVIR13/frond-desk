...
import * as Icons from "react-icons/fa";
 ...
 import axios from "axios";
  ...
  export default function OthersContractors() {
  ...
  const [otherContractors,setOtherContractors] =useState([])
  ...
  function getOtherContractorList(){
    
    axios.get('https://localhost:7194/api/Visitors/GetAllVistors')
    .then((Response)=>{
      setOtherContractors(Response.data);
...
useEffect(()=>{
  ...
  return (
    <div className="OtherContractors-page">
      <Navbar/>
...
<button style= {{backgroundColor:"rgb(225, 232, 235)"}}  className= "OtherContractors-List-btn">Other Contractors</button>
        ...
        <div className="OtherContractors-eyeIcon">
        {showHideCheckboxes ? (
...
<FormControlLabel control={
    ...
    <div className='OtherContractors-icon'><Icons.FaSortAmountDown/>sort</div>
    <div className='OtherContractors-icon'><Icons.FaFilter/>filter</div>
    <button  className="OtherContractors-add-btn">Add Other Contractors</button>
    </div>
    </div>



    <div className='OtherContractors-table'>
   
              <div className="OtherContractors-table-container">
              <Table>
        <TableHead>
          <TableRow>
